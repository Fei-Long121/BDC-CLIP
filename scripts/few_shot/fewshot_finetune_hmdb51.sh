...
VAL_FILE1=./configs/few_shot/pretrained_on_k400/hmdb51/bdc_clip_fs_hmdb51_2_shot.yaml
VAL_FILE2=./configs/few_shot/pretrained_on_k400/hmdb51/bdc_clip_fs_hmdb51_4_shot.yaml
VAL_FILE3=./configs/few_shot/pretrained_on_k400/hmdb51/bdc_clip_fs_hmdb51_8_shot.yaml
VAL_FILE4=./configs/few_shot/pretrained_on_k400/hmdb51/bdc_clip_fs_hmdb51_16_shot.yaml
VAL_FILES=($VAL_FILE1 $VAL_FILE2 $VAL_FILE3 $VAL_FILE4)

base_output_path=./hmdb51_few_shot_finetuned
