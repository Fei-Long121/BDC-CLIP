...
output_path=./k600_zeroshot

llm_json_path=./prompts/K600/k600.json
model_path=./output_zeroshot_pretrain/ckpt_epoch_9.pth

VAL_FILE1=./configs/zero_shot/k600/bdc_clip_zs_k600_split1.yaml
VAL_FILE2=./configs/zero_shot/k600/bdc_clip_zs_k600_split2.yaml
VAL_FILE3=./configs/zero_shot/k600/bdc_clip_zs_k600_split3.yaml
