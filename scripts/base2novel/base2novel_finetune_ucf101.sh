...
VAL_FILE=./configs/base2novel/pretrained_on_k400/ucf101/bdc_clip_s1.yaml
VAL_FILES=($VAL_FILE)
output_path=./ucf101_base2novel_finetuned
...
VAL_FILE_NOVEL=./configs/base2novel/pretrained_on_k400/ucf101/bdc_clip_s1.yaml
...
VAL_FILE_NOVEL=./configs/base2novel/pretrained_on_k400/ucf101/bdc_clip_novel_eval.yaml
VAL_FILES=($VAL_FILE_NOVEL)
for split_path in "${VAL_FILES[@]}"; do
    PYTHONWARNINGS="ignore" python -m torch.distributed.launch --nproc_per_node=2 main.py \
     -cfg $split_path \
